...
data['Estimated Annual PV Energy Production (kWh)'] = pd.to_numeric(data[data['Estimated Annual PV Energy Production (kWh)'] == selected_county].str.replace(',', ''), errors='coerce')
